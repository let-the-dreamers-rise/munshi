window.MUNSHI_REPLAY = {
 "recorded_at": "12 Sep 2026, 12:20",
 "initial": {
  "household": "meera",
  "now": "2026-09-12 12:20",
  "watched": {
   "payments": 212,
   "days": 99
  },
  "cards": [
   {
    "id": "card-c11276d105ff",
    "event_id": "c11276d105ff",
    ...
    "amount": 12000.0,
    "when": "2026-09-12 12:15",
    "drafts": {
     "cybercrime_report": {
      "where": "1930 and https://cybercrime.gov.in",
      "call_before": "13:15 on 12 Sep 2026",
      "text": "Call 1930 now, before 13:15. The first hour is when a bank can still hold the money. Read them the fields below, then file the same details at cybercrime.gov.in under financial fraud and keep the acknowledgement number.",
      "fields": {
       "Category": "Online Financial Fraud",
       "Sub-category": "UPI related fraud",
       "Date and time of transaction": "12 Sep 2026, 12:15",
       "Amount (Rs)": "12,000",
       ...
       "What happened": "I received a message from +919811234567 containing 'kyc', 'blocked' and 'immediately'. 9 minutes later, Rs 12,000 left my HDFC Bank account ending 4521 to kyc.update9@ybl on 12 Sep 2026, 12:15 (reference 624511873920). I had never paid this recipient before."
      }
     },
     "bank_dispute": {
      "subject": "Unauthorised UPI debit of Rs 12,000 on 12 Sep 2026, 12:15, reference 624511873920",
      "body": "To the dispute desk, HDFC Bank\n\nAccount ending 4521\nAmount: Rs 12,000\nDate and time: 12 Sep 2026, 12:15\nReference: 624511873920\nRecipient: kyc.update9@ybl\n\nI did not knowingly authorise this payment to kyc.update9@ybl. Please block further debits to this recipient, raise a dispute, and ask the receiving bank to hold the amount. I am reporting it to 1930 and cybercrime.gov.in.\n\nThank you.",
     ...
     "upi_help": {
      ...
      "amount": "12,000",
      "date": "12 Sep 2026, 12:15",
      "recipient": "kyc.update9@ybl",
      "note": "In the UPI app you paid from, open UPI Help (or Help, then report an issue) on this payment."
     }
    },
    "interrupt_id": "v1:tool_call:playbook-f74b0e040a87:a03c9326-dd4c-5878-95a5-2d96fbe58668",
    "session_id": "meera-c11276d105ff",
    "decided_by": "rules",
    "created": "2026-09-12T12:20:51",
    "status": "pending",
    "decision": "",
    "outcome": "",
    "decided": ""
   },
   {
    ...
    "drafts": {},
    "interrupt_id": "v1:tool_call:playbook-6795282c0776:a03c9326-dd4c-5878-95a5-2d96fbe58668",
    "session_id": "meera-7aae1c1a494d",
    "decided_by": "rules",
    "created": "2026-09-12T12:20:52",
    "status": "pending",
    "decision": "",
    "outcome": "",
    "decided": ""
   },
   {
    ...
    "interrupt_id": "v1:tool_call:playbook-bb2009adcb20:a03c9326-dd4c-5878-95a5-2d96fbe58668",
  ...
  "audit": [
   ...
   },
   {
    ...
    "status": "success",
    "refused": null,
    "result": "{\"subject\": \"Unauthorised UPI debit of Rs 12,000 on 12 Sep 2026, 12:15, reference 624511873920\", \"body\": \"To the dispute desk, HDFC Bank\\n\\nAccount ending 4521\\nAmount: Rs 12,000\\nDate and time: 12 Sep 2026, 12:15\\nReference: 624511873920\\nRecipient: kyc.update9@ybl\\n\\nI did not knowingly authorise this payment to kyc.update9@ybl. Please block further debits to this recipient, raise a dispute, and",
    "ms": 2.4
   },
   {
    "at": "2026-09-12T12:20:51",
    ...
    "status": "success",
    "refused": null,
    "result": "{\"applies\": true, \"issue\": \"Fraud or unauthorised transaction\", \"transaction_ref\": \"624511873920\", \"amount\": \"12,000\", \"date\": \"12 Sep 2026, 12:15\", \"recipient\": \"kyc.update9@ybl\", \"note\": \"In the UPI app you paid from, open UPI Help (or Help, then report an issue) on this payment.\"}",
    "ms": 1.5
   },
   {
    "at": "2026-09-12T12:20:51",
    ...
    "audit": [
     {
      ...
      "status": "success",
      "refused": null,
      "result": "{\"event_id\": \"c11276d105ff\", \"party\": \"kyc.update9@ybl\", \"decision\": \"fine\", \"next_steps\": [\"Noted. Munshi will not ask about this payee again.\"]}",
      "ms": 2.0
     },
     {
      "at": "2026-09-12T12:20:52",
  ...
  "card-7aae1c1a494d": {
   "keep": {
    "card": {
     ...
     "decided": "2026-09-12T12:20:53"
    },
    "audit": [
     {
      "at": "2026-09-12T12:20:53",
      "agent": "munshi",
      "tool": "ask_household",
      "input": {
       "event_id": "7aae1c1a494d"
  ...
  "card-7265498325d2": {
   ...
   "fine": {
    "card": {
     ...
     "decision": "fine",
     "outcome": "Noted. Munshi will not ask about this payee again.",
     "decided": "2026-09-12T12:20:54"
    },
    "audit": [
     {
      "at": "2026-09-12T12:20:54",
      "agent": "munshi",
      "tool": "ask_household",
      "input": {
       "event_id": "7265498325d2"
